...
func ListtagsforresourceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Resolver.ListTagsForResource%s", cfg.BaseURL, queryString)
...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53Resolver_ListTagsForResource",
		mcp.WithDescription("Lists the tags that you associated with the specified resource."),
