...
func DeleteresolverquerylogconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteResolverQueryLogConfigRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Resolver.DeleteResolverQueryLogConfig", cfg.BaseURL)
		...
		var result models.DeleteResolverQueryLogConfigResponse
...
func CreateDeleteresolverquerylogconfigTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteresolverquerylogconfigHandler(cfg),
	}
}
