...
func ListfirewallrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListFirewallRulesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Resolver.ListFirewallRules%s", cfg.BaseURL, queryString)
		...
		var result models.ListFirewallRulesResponse
...
func CreateListfirewallrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53Resolver_ListFirewallRules",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListfirewallrulesHandler(cfg),
	}
}
