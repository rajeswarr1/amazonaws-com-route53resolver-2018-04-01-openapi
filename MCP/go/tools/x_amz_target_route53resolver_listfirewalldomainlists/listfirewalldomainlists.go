...
func ListfirewalldomainlistsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListFirewallDomainListsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Resolver.ListFirewallDomainLists%s", cfg.BaseURL, queryString)
		...
		var result models.ListFirewallDomainListsResponse
...
func CreateListfirewalldomainlistsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53Resolver_ListFirewallDomainLists",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListfirewalldomainlistsHandler(cfg),
	}
}
