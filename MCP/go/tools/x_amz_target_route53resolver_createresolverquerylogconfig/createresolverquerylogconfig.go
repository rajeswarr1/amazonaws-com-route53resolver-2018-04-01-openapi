...
func CreateresolverquerylogconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateResolverQueryLogConfigRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Route53Resolver.CreateResolverQueryLogConfig", cfg.BaseURL)
		...
		var result models.CreateResolverQueryLogConfigResponse
...
func CreateCreateresolverquerylogconfigTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Route53Resolver_CreateResolverQueryLogConfig",
		...
		mcp.WithString("DestinationArn", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateresolverquerylogconfigHandler(cfg),
	}
}
